...
class CliSettingsSource(EnvSettingsSource, Generic[T]):
    ...
    def __call__(
        ...
        *,
        ...
        parsed_args: (
            Namespace | SimpleNamespace | dict[str, list[str] | str] | None
        ) = None,
                ...
                for model in sub_models:
                    ...
                    subparsers = (
                        self._add_subparsers(
                            ...
                            description=(
                                field_info.description if len(sub_models) > 1 else None
                            ),
                        )
    ...
    def _metavar_format_recurse(self, obj: Any) -> str:
        ...
        if is_union_origin(origin):
            ...
            return self._metavar_format_choices(
                list(map(self._metavar_format_recurse, self._get_modified_args(obj))),
                obj_qualname=(
                    obj.__qualname__ if hasattr(obj, "__qualname__") else str(obj)
                ),
            )
